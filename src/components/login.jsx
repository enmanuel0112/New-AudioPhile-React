        ...
        <div className="login-form">
          <div className="logo">
            <Link to="/">
              {" "}
              <img
                src={`${process.env.PUBLIC_URL}/assets/shared/desktop/logo 1.png`}
                alt=""
              />
            </Link>
          </div>
          ...
          <div className="login">
            <div className=" login-content">
              ...
              <p>
                {changeLoginToRegister
                  ? "create a free account and start using"
          ...
          <div className="login">
            ...
            <form action="" onSubmit={onSubmit}>
              <label
                htmlFor="name"
                className={
                  changeLoginToRegister ? "input-hidden" : " input-active"
                }
              >
                <p>Name</p>
                <div className="input">
    ...
    <div className="login-section">
      <div className="login-container">
        ...
        <div className="login-image">
          <img
            src={`${process.env.PUBLIC_URL}/assets/product-xx99-mark-one-headphones/desktop/image-gallery-3.jpg`}
            alt=""
          />
          <div className="slogan">
            <h3>i simply love it !</h3>
            <p>
              Live the best moments listening to the best music with{" "}
              <span>audiophile</span> products.
            </p>
          </div>
        </div>
